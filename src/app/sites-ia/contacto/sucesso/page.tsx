  ...
  return (
    <section className="mx-auto max-w-xl px-4 sm:px-6 py-24 text-center">
      ...
      <p className="mt-4 text-gray-600">
        Obrigado pelo interesse na NextIA Marketing. Recebemos o teu briefing
        e vamos entrar em contacto dentro de 24h úteis com os próximos
        passos. Enviámos também um email de confirmação.
      </p>
      <Link
        href="/"
